...
public void sendEmail(Enquiry enquiry) throws AddressException, MessagingException {
		...
		String[] toEmails = {enquiry.getEmailId(),"jmpvttutorials@gmail.com" };
		String emailSubject = "Enquiry Made for STD "+enquiry.getStd()+" with Name "+enquiry.getStudentName();
		String emailBody = "Hi,"+newline+newline
				+ "Student with Name : " +enquiry.getStudentName()+ " and Enquiry ID : "+enquiry.getStd()+" Has made an Enquiry"+newline
				+ ""+newline
				+ ""+newline
				+"Call 9930851959 For Further Queries"
				+ ""+newline
